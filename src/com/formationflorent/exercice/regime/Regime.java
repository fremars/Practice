...
public class Regime {
    public static void main(String[] args) {
        ...
        repasSoir.nom = "Salade de pâte + Eau + Compté";
        repasSoir.nbCaloriesGagnees = 547;
        repasSoir.consommer();

        System.out.println("Après " + Repas.nbRepas + " repas et "+ Activite.nbActivite + " activité mon apport calorique du jours est de " + Repas.compteurCalories + " calories");
